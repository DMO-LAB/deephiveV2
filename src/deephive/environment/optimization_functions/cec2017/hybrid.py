...
def f11(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1100.0 if negative else -y - 1100.0


def f12(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1200.0 if negative else -y - 1200.0


def f13(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1300.0 if negative else -y - 1300.0


def f14(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1400.0 if not negative else -y - 1400.0


def f15(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1500.0 if not negative else -y - 1500.0


def f16(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1600.0 if not negative else -y - 1600.0


def f17(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1700.0 if not negative else -y - 1700.0


def f18(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1800.0 if not negative else -y - 1800.0


def f19(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 1900.0 if not negative else -y - 1900.0


def f20(x, rotation=None, shift=None, shuffle=None, negative=True):
    """
    ...
    return y + 2000.0 if not negative else -y - 2000.0
