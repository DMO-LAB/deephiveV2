...
# python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --freeze --role_std_exploiters 0.4 --role_std_explorers 0.4 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --decay_std --decay_start $DECAY_START --split_type "use_stds" --plot_gbest --iters $ITERS --tol $TOL
...
# echo "Running experiment $EXP_NUM: $TITLE"
# python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --freeze --role_std_exploiters 0.4 --role_std_explorers 0.4 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --decay_std --decay_start 4 --split_type "use_stds" --plot_gbest --iters $ITERS --tol $TOL
...
echo "Running experiment $EXP_NUM: $TITLE"
python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --role_std_exploiters 0.5 --role_std_explorers 0.5 --variable_std --action_std $ACTION_STD --decay_rate 0.9 --decay_std --decay_start 5 --split_type "use_stds" --plot_gbest --iters $ITERS --tol $TOL
...
echo "Running experiment $EXP_NUM: $TITLE"
python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --role_std_exploiters 0.02 --role_std_explorers 0.2 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --split_agents --split_type "use_stds" --plot_gbest --iters $ITERS --tol $TOL
