...
Experiment 2: NO SPLITTING - FREEZE
EXP_NUM=$((EXP_NUM+1))
exp_list="$exp_list,$EXP_NUM"
...
echo "Running experiment $EXP_NUM: $TITLE"
python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --role_std_exploiters 0.03 --role_std_explorers 0.4 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --split_agents --split_type "use_stds" --plot_gbest --iters $ITERS --tol $TOL --dynamic_split --split_interval $SPLIT_INTERVAL --use_split_interval
...
EXP_NUM=$((EXP_NUM+1))
exp_list="$exp_list,$EXP_NUM"
TITLE="SPLITTING-USE GRID-gbest - Dynamic-split"
echo "Running experiment $EXP_NUM: $TITLE" 
python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --use_gbest --role_std_exploiters 0.03 --role_std_explorers 0.03 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --split_agents --split_type "use_grid" --plot_gbest --iters $ITERS --tol $TOL --exploit_std 0.03 --policy_type "gbest"  --dynamic_split --split_interval $SPLIT_INTERVAL --use_split_interval
...
echo "Running experiment $EXP_NUM: $TITLE"
python $SCRIPT_NAME --title "$TITLE" --exp_num $EXP_NUM --role_std_exploiters 0.5 --role_std_explorers 0.5 --variable_std --action_std $ACTION_STD --decay_rate $DECAY_RATE --split_agents --split_type "use_two_policies" --plot_gbest --iters $ITERS --tol $TOL --exploit_std 0.03 --dynamic_split --split_interval $SPLIT_INTERVAL --use_split_interval
